...
// Generated by metaharness — the `coding-harness` CLI entry point.
//
// This is plain ESM JavaScript on purpose: it runs as-is via `npx coding-harness`
...
// "bin" + "files" fields in package.json), so `npx coding-harness` works the moment
...
const HARNESS_NAME = 'coding-harness';

/** `coding-harness init` — boot the kernel + host adapter and report status. */
async function init() {
...
/** `coding-harness doctor` — verify the install end-to-end (kernel + host resolve). */
