...
const M0_AUTHORITY_PATHS = [
  ...
  'coding-harness/__tests__/effective-config-current-state.test.ts', 'coding-harness/__tests__/m0-authority.test.ts', 'coding-harness/__tests__/select-ci-gates.test.ts',
