...
export const SECURE_HARNESS_CONFIG = parseHarnessConfig({
  ...
  requiredProtectedPaths: [
    ...
    'coding-harness/__tests__/immutable-private-tree-overlay.test.ts', 'coding-harness/__tests__/packed-controller-overlay-assets.test.ts', 'coding-harness/__tests__/select-ci-gates.test.ts',
    ...
    'coding-harness/scripts/deny-publish.mjs', 'coding-harness/scripts/harden-build.mjs', 'coding-harness/scripts/select-ci-gates.mjs',
    ...
    'docs/adr/ADR-0048-rust-production-and-node-evidence-runtime-boundary.md', 'docs/adr/ADR-0049-exact-recursive-property-path-fixed-points.md', 'docs/adr/ADR-0050-verified-source-generation-leases-schema-identity-and-atomic-runtime-activation.md', 'docs/adr/ADR-0051-postgresql-16-public-observed-schema-profile.md', 'docs/design/ADR-0050-observed-schema-identity-v1-contract.md', 'docs/design/ADR-0050-observed-schema-identity-v1-known-answer-vectors.md',
