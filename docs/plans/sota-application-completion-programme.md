...
|---|---:|---:|---|
| Correctness and standards | 25 | 17 | Strong fixed differential/W3C coverage; path truncation, one R2RML deviation, fail-open inventory, and no generative/fuzz layer |
