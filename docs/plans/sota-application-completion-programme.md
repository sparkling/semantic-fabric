...
Commits `28addbc`/`c586973` add the 232,822-byte exact catalogue (`e7ce3572…e69`; 9,125 nodes, 963 records), bounded pre-scan/one-parse contract verifier, caller-pinned digest binder, 123 KATs, and 85 PostgreSQL 16.15 deparse facts with zero fixture mismatch. Service tests pass 412/412 under Node 20 and 24 with identical internal artifact `5aff413e…ef53` and unchanged public bundle `90e21e7c…f7c3a`; the parent suite passes 889 tests with two expected skips on both runtimes.
