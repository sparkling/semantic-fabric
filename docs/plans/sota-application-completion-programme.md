...
ADR-0042/0043/0044 remain proposed: no migrations, live PostgreSQL adapter, writer connection, deployed signer, network, external administrator, lease/fence/outbox publisher, runner, attempt, capture authority, or real supervisor event exists.
