...
Commits `28addbc`/`c586973` add the 232,822-byte exact catalogue (`e7ce3572…e69`; 9,125 nodes, 963 records), bounded pre-scan/one-parse contract verifier, caller-pinned digest binder, 123 KATs, and 85 PostgreSQL 16.15 deparse facts with zero fixture mismatch. Commit `f192a8b` makes shared capability admission reject hidden symbol keys before invocation. ADR-0047's exact-platform-manifest-pinned PostgreSQL 16.15 fixture has 4,059 records and 860,988 bytes (`a108e05f…5be`). Its closed receipt and owned networkless replay now bind two fresh anonymous-volume `template0` runs, full profiles/results, independent raw-SQL transcripts and ownership-checked cleanup; runtime admission still awaits the no-membership witness, exhaustive hostile/runtime gates and a passing live Node 20/24 replay matrix. Service tests pass 477/477 under Node 20 and 24 with identical internal artifact `e296eabc2480d10b5bcb1ea8629e1855f82a1695891a0e96958de2b81e65b358` and unchanged public bundle `90e21e7c…f7c3a`; the parent focused protected-capability suite passes on Node 24 and the prior full parent suite remains 889 tests with two expected skips on both runtimes.
