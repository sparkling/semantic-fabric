...
> **Graduation note (2026-09-01).** The virtualizer and public three-backend
> serving path now run, so these dimensions are actionable. Accepted ADR-0038
> sequences them as application-completion milestones and hard gates. This record
> stays `proposed`; the graduation note does not mark any item below implemented.
...
* **Completion programme:** accepted ADR-0038 and `docs/plans/sota-application-completion-programme.md`.
