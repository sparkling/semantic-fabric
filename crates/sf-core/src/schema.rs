//! Dialect-neutral relational schema model — primary keys, foreign keys,
//! uniqueness, and cardinality estimates (ADR-0006, ADR-0007, ADR-0015).
//!
//! These are pure value types shared by mapping generation, source
//! introspection, query optimization, and cost planning. They perform no I/O;
//! per-DBMS catalogue reads and physical planning remain in `sf-sql`.
